...
#     Optional[Branches], Optional[Actions], Optional[Task], Optional[ActionsCore], Optional[IssueActions], Optional[
#         TopicActions], Optional[
#         PoomCiActions]]:
#     branch: Optional[Branches] = None
#     branch_action: Optional[Actions] = None
#     subject: Optional[Task] = None
...
#             subject = Task[arg.upper().replace('-', '_')]
...
#     Optional[Actions], Optional[Branches], Optional[Task], Optional[ActionsCore], Dict[
